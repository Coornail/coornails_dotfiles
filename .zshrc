...
plugins=(catimg compleat colored-man colorize composer docker git gitignore github gnu-utils history-substring-search jsontools tmux torrent vagrant vi-mode web-search z)
